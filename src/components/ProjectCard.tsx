...
export function ProjectCard({ slug, frontmatter }: ProjectCardProps) {
  ...
  return (
    <article className="group rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
      {/* Project Image */}
      ...
      <div className="p-5">
        <Link href={`/projects/${slug}`}>
          <h3 className="font-semibold text-lg mb-2 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
            {title}
          </h3>
        </Link>
